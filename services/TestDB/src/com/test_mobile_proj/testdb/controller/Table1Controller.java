...
import com.test_mobile_proj.testdb.service.Table1Service;
 ...
 * @see com.test_mobile_proj.testdb.Table1
 */

@RestController(value = "TestDB.Table1Controller")
@Api(value = "/TestDB/Table1", description = "Exposes APIs to work with Table1 resource.")
@RequestMapping("/TestDB/Table1")
public class Table1Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table1Controller.class);

	@Autowired
	@Qualifier("TestDB.Table1Service")
